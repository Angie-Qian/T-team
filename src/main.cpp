...
void initialize() {
  ...
  // chassis.odom_tracker_left_set(&vert_tracker); (*uncomment when using vertical tracking wheel)
 ...
 * the Field Management or the VEX Competition Switch in the autonomous
...
void screen_print_tracker(ez::tracking_wheel *tracker, std::string name, int line) {
  ...
  ez::screen_print(tracker_value + tracker_width, line);  // Print final tracker textc 
}
...
pros::lcd::print(6, "H: %.2f", chassis.odom_theta_get());
  ...
  //       master.rumble(".");  // just test if ANY button works
  //   }
